        ...
        <div class="row">
                <div class="container">
                  ...
                  {{ errors }}
                    ...
                    <input type="text" placeholder="Enter Username" id="uname" :class="{'is-invalid' : errors.email }" v-model="email" required>
                    ...
                    <input type="password" placeholder="Enter Password" id="psw" :class="{'is-invalid' : errors.password }" v-model="password" required>
                      ...
                      <div class="invalid-feedback" v-if="errors.invalid">{{ errors }}</div>

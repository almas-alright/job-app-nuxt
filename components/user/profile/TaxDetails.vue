    ...
    <div class="container">
      ...
      <div v-if="!showEditForm" class="row">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <dl class="row">
            <dt class="col-sm-6"> TFN NUMBER:</dt>
            <dd class="col-sm-6"> {{ taxData.tfn_number }}</dd>
          </dl>
          <dl v-if="taxData.has_abn.status" class="row">
            <dt class="col-sm-6"> ABN NUMBER:</dt>
            <dd class="col-sm-6"> {{ taxData.has_abn.abn_number }}</dd>
          </dl>
          <dl v-if="!taxData.has_abn.status" class="row">
            <dt class="col-sm-6"> ACCEPT ABN CREATE?:</dt>
            <dd class="col-sm-6"> {{ taxData.has_abn.abn_accept }}</dd>
          </dl>
          <dl v-if="taxData.has_super_number.status" class="row">
            <dt class="col-sm-6"> SUPER NUMBER :</dt>
            <dd class="col-sm-6"> {{ taxData.has_super_number.super_number }}</dd>
          </dl>
        </div>
      </div>
